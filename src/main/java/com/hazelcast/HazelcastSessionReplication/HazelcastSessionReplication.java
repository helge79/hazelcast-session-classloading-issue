    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("action") != null) {
            if (request.getParameter("action").equals("Set Attribute") && request.getParameter("key") != null
                ...
                session.setAttribute(request.getParameter("key"), new StringHolder((String)request.getParameter("value")));
            }

            if (request.getParameter("action").equals("Get Attribute") && request.getParameter("key") != null) {
                request.setAttribute("getKey", ((StringHolder)session.getAttribute(request.getParameter("key"))).getValue());
            }
